...
class ModerationTemplates
{
  public:
    struct Cols
    {
        ...
        static const std::string _template_text;
     ...
     */
    explicit ModerationTemplates(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit ModerationTemplates(const Json::Value &pJson) noexcept(false);
     ...
     */
    ModerationTemplates(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);

    ModerationTemplates() = default;
    ...
    /**  For column template_text  */
    ///Get the value of the column template_text, returns the default value if the column is null
    const std::string &getValueOfTemplateText() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getTemplateText() const noexcept;
    ///Set the value of the column template_text
    void setTemplateText(const std::string &pTemplateText) noexcept;
    void setTemplateText(std::string &&pTemplateText) noexcept;
  ...
  private:
    friend drogon::orm::Mapper<ModerationTemplates>;
    friend drogon::orm::BaseBuilder<ModerationTemplates, true, true>;
    friend drogon::orm::BaseBuilder<ModerationTemplates, true, false>;
    friend drogon::orm::BaseBuilder<ModerationTemplates, false, true>;
    friend drogon::orm::BaseBuilder<ModerationTemplates, false, false>;
#ifdef __cpp_impl_coroutine
    friend drogon::orm::CoroMapper<ModerationTemplates>;
#endif
    ...
    std::shared_ptr<std::string> templateText_;
