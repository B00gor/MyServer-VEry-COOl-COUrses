...
class Users
{
  public:
    struct Cols
    {
        ...
        static const std::string _profile_is_public;
    ...
    /**  For column profile_is_public  */
    ///Get the value of the column profile_is_public, returns the default value if the column is null
    const bool &getValueOfProfileIsPublic() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<bool> &getProfileIsPublic() const noexcept;
    ///Set the value of the column profile_is_public
    void setProfileIsPublic(const bool &pProfileIsPublic) noexcept;
    void setProfileIsPublicToNull() noexcept;
    ...
    ///Get the value of the column information, returns the default value if the column is null
    const std::string &getValueOfInformation() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getInformation() const noexcept;
    ///Set the value of the column information
    void setInformation(const std::string &pInformation) noexcept;
    void setInformation(std::string &&pInformation) noexcept;
    void setInformationToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<bool> profileIsPublic_;
    std::shared_ptr<std::string> contacts_;
    std::shared_ptr<std::string> information_;
